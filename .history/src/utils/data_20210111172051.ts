...
export const projects: IProject[] = [
  ...
  {
    description:
      "Movies is an online database of information related to movies, TV Series – including cast, production crew and personal biographies, plot summaries, ratings",
    image: "movies",
    name: "Movies",
