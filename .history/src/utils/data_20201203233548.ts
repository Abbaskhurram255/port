...
export const projects: IProject[] = [
  ...
  {
    description:
      "The Maze is a game of challenging mazes. The game has 5 difficulty levels, and each of them has infinite mazes and stages. So, this means that the game has no repeating mazes! HoLet's see if you can beat the computer",
    image: "maze",
    name: "The Maze",
