...
export const projects: IProject[] = [
  ...
  {
    description:
      "Want to build a new habit? Orchards made it easy! Install the app, submit the habit(s) you want to build, and tick the check every day to let the app know you were strong enough not to ",
    image: "orchard",
    name: "Orchard",
