...
export const projects: IProject[] = [
  ...
  {
    description:
      "Want to build a new habit? Orchards makes it easy!Grow forth by completing your daily goals with this minimal and colorful habit tracker. Install the app, submit the habit(s) you want to build, and tick the check every time you reach your goal",
    image: "orchard",
    name: "Orchard",
