...
export const projects: IProject[] = [
  ...
  {
    description:
      "Find out how your net worth – the difference between what you own (your assets) and what you owe (your liabilities) compares to other earthlings. Understanding that difference is a great way to help you plan for the future",
    image: "fisave",
    name: "Fisave",
