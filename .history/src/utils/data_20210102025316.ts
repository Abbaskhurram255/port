...
export const projects: IProject[] = [
  ...
  {
    description:
      "Want to build a new habit? If no, I assume you might be strugglingOrchards makes it easy! Grow forth by completing your daily goals with this minimal habit tracker. Install the app, submit the habit(s) you want to build or goal(s) you want to reach, and mark the goal as done every day you reach it... And voila!",
    image: "orchard",
    name: "Orchard",
