...
export const projects: IProject[] = [
  ...
  {
    description:
      "The Maze is a game of challenging mazes. The game has 5 difficulty level, and each of them has infinite mazes. In other words, there is no ending to this game",
    image: "maze",
    name: "The Maze",
