...
export const projects: IProject[] = [
  ...
  {
    description:
      "Movies is an online database of information related to movies, TV Series, home videos, video games, and streaming content online – including cast, production crew and personal biographies, plot summaries, trivia, ratings, and fan and critical reviews",
    image: "movies",
    name: "Movies",
