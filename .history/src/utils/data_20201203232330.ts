...
export const projects: IProject[] = [
  ...
  {
    description:
      "The Maze is a game of challenging mazes. The game has 5 difficulty levels, and each of them has infinite mazes and levels. So this means that no repeating mazes",
    image: "maze",
    name: "The Maze",
